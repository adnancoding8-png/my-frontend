      ...
      <Card>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="whatsapp-phone-id" className="flex items-center gap-2">
                <Phone className="h-4 w-4" />
                WhatsApp Phone Number ID
              </Label>
              <Input
              ...
              {validationErrors.phoneNumberId && (
                <p className="text-sm text-red-500">{validationErrors.phoneNumberId}</p>
              )}
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              <Label htmlFor="whatsapp-access-token" className="flex items-center gap-2">
                <Phone className="h-4 w-4" />
                WhatsApp Access Token
              </Label>
              <Input
              ...
              {validationErrors.accessToken && (
                <p className="text-sm text-red-500">{validationErrors.accessToken}</p>
              )}
              <p className="text-sm text-muted-foreground">
                Get this from your WhatsApp Business Account settings. This is kept secure and never displayed.
              </p>
            </div>
