...
// Index is already created by unique: true on the key field above
...
SettingsSchema.statics.getWhatsAppConfig = async function() {
  const settings = await this.find({
    key: { $in: ['whatsapp_number', 'whatsapp_message', 'whatsapp_enabled', 'whatsapp_phone_number_id', 'whatsapp_access_token'] },
    isActive: true
  });
